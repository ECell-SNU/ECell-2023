...
// console.log(window);
  ...
  useEffect(() => {
    document.getElementById("__next").className = "rootColor";
  }, [param]);
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="Mode">
              <img src={Mode === "light" ? moon.src : sun.src} alt="moon" />
                      ...
                      return (
                        <li key={index}>
                          <a href={icon.link} rel="noreferrer" target="_blank">
                            <img src={icon.icon.src} alt="icon" height="17px" />
                          </a>
                        </li>
                      );
                    else
