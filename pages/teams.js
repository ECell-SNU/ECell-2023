import "../styles/routes/Team/TeamPage.scss";
...
import DropDown from "../Components/Team/DropDownGui/DropDown";
    ...
    <div className="TeamPageWrapper">
      <main>
        <header>
          ...
          >
            <a href="/" className="TeamPageNavbar__button">
              &larr; &nbsp; &nbsp;Go Back
            </a>
            <a href="/" className="TeamPageNavbar__responsive">
              &larr;
            </a>
