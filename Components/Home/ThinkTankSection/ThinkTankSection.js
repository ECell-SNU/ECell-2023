...
import LandingSectionTexts from "../../Common/LandingSectionTexts/LandingSectionTexts";
...
function ThinkTankSection(props) {
  ...
  return (
    <section className="ThinkTankSectionWrapper" id="thinktank" {...props}>
      <div className="ThinkTankSectionWrapper__content-container">
        {!isMobile && (
          <div className="animationWrapper">
            <img className="animation-holder" src={icon.src} alt="icon" />
            {/*<motion.div
